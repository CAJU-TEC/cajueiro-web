  ...
  <q-page padding>
    <div class="q-pb-md q-gutter-sm">
      <q-breadcrumbs>
        ...
        <q-breadcrumbs-el label="Impactos" />
      </q-breadcrumbs>
    </div>
    <q-table
      v-model="pagination"
    ...
    >
      ...
      <template #top>
        <span class="text-h4">Impactos</span>
        <q-space />
        <q-btn color="primary" push :to="{ name: 'impacts.form' }">
...
export default defineComponent({
  ...
  setup() {
    const impacts = ref([]);
    const { list, remove } = impactsService();
    ...
    const handleEditClient = async (id) => {
      router.push({ name: 'impacts.form', params: { id } });
    };
